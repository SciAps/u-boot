...
/* More manufacturing unique data for each SOM */
ID_KEY_ENTRY(lan_ethaddr1)
ID_KEY_ENTRY(lan_ethaddr2)
ID_KEY_ENTRY(lan_ethaddr3)
ID_KEY_ENTRY(lan_ethaddr4)

/* DDR datasheet information */
ID_KEY_ENTRY(datasheet)
ID_KEY_ENTRY(raswidth)
ID_KEY_ENTRY(caswidth)
ID_KEY_ENTRY(ramsize)	/* Since CS size in MB */
ID_KEY_ENTRY(timing)	/* Datashee timing, array */
ID_KEY_ENTRY(tCK)	/* Picoseconds */
ID_KEY_ENTRY(tRFC)
ID_KEY_ENTRY(tRC)
ID_KEY_ENTRY(tRAS)
ID_KEY_ENTRY(tRP)
