#ifndef __PROD_ID_INTERFACE_H__
#define __PROD_ID_INTERFACE_H__
...
/* id_fetch_bytes is like id_fetch_byte, but copy the data read into mem_ptr */
...
extern int id_array_element(struct id_cookie *cookie, int idx, idenum_t type);
extern int id_array_size(struct id_cookie *cookie);
